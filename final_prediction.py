...
class Application:
    ...
    def __init__(self):
        ...
        #Character and GUI Variable Initialization
        self.ct = {}
        self.ct['blank'] = 0
        self.blank_flag = 0
        ...
        self.b1=tk.Button(self.root,text="Action 1", command=self.action1)
        self.b1.place(x=390,y=700)

        self.b2 = tk.Button(self.root,text="Action 2", command=self.action2)
        self.b2.place(x=590, y=700)

        self.b3 = tk.Button(self.root,text="Action 3", command=self.action3)
        self.b3.place(x=790, y=700)

        self.b4 = tk.Button(self.root,text="Action 4", command=self.action4)
    ...
    def predict(self, test_image):
        ...
        #Condition for [g,h][b,d,f,i,k,r,u,v,w]
        ...
        #Condition for [p,q,z][a,e,m,n,s,t]
